...
/**
 * Parses a RSS Feed XML
 * Lars Vogel - http://www.vogella.com/tutorials/RSSFeed/article.html
...
public class RSSFeedParser implements Serializable  {
	...
	public RSSFeedParser(String feedUrl) {
		try {
			...
			throw new RuntimeException("INVALID URL FETCHED FROM DB. PLEASE FIX ME ASAP");
		}
	}
