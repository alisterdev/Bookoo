...
public class ClientDAOImplTest {
	...
	public void testUpdateClientRecord() throws SQLException {
		...
		int results = cdi.updateClientRecord(clientBean);
	...
	public void testUpdateInvalidClientBean() throws SQLException {
		cdi.updateClientRecord(clientBean);
	}
	...
	public void testSearchAllClients() throws SQLException{
		...
		List<ClientBean> test = cdi.getAllClients();
	...
	public void testSearchClient() throws Exception{
		...
		clientBean.setId(1);
//		ArrayList<ClientBean> test = cdi.searchClient(clientBean);
		
//		if(test==null){
//			fail("Unexcepted null");
//		}
//		if(Long.valueOf(test.get(0).getId())==null){
//			fail("Unexcepted values for the client ID");
//		}
//		if(test.get(0).getId()!=1){
//			fail("Unexcepted values for the client ID");
//		}
	}
...
//		cdi.searchClient(clientbean);
		fail("ClientBean ne peut être nul");
	}
...
//		ArrayList<ClientBean> test = cdi.searchClient(clientBean);
//		if(Long.valueOf(test.get(0).getId())==null){
//			fail("We shouldn't find something there");
//		}
	}
